...
const uint8_t ip[64] = {58, 50, 42, 34, 26, 18, 10, 2,  60, 52, 44, 36, 28,
...
const uint8_t pc1[56] = {57, 49, 41, 33, 25, 17, 9,  1,  58, 50, 42, 34, 26, 18,
...
const uint8_t expand[48] = {32, 1,  2,  3,  4,  5,  4,  5,  6,  7,  8,  9,
                            8,  9,  10, 11, 12, 13, 12, 13, 14, 15, 16, 17,
                            16, 17, 18, 19, 20, 21, 20, 21, 22, 23, 24, 25,
                            24, 25, 26, 27, 28, 29, 28, 29, 30, 31, 32, 1};

const uint8_t ip1[64] = {40, 8,  48, 16, 56, 24, 64, 32, 39, 7,  47, 15, 55,
...
const uint8_t fp[32] = {16, 7, 20, 21, 29, 12, 28, 17, 1,  15, 23,
